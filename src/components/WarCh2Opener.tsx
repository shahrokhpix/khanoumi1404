    ...
    <section id="ch2" data-reveal className="relative overflow-hidden bg-white">
      <div className="relative isolate min-h-[min(72dvh,40rem)] w-full lg:min-h-[min(78dvh,48rem)]">
        ...
        >
          ...
          <p className="font-fanum m-0 max-w-[min(100%,38rem)] rounded-xl border border-white/20 bg-white/92 px-4 py-3 text-[clamp(12px,1.5vw,15px)] font-bold leading-7 text-black shadow-[0_10px_28px_rgba(0,0,0,0.25)] sm:px-5">
            {CHAPTER2.nazmabad}
          </p>
        </div>
      </div>
